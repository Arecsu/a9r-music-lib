...
def lastfm_scrapper(artist):
    encode_artist_url = quote(artist)
    input_url = f"https://www.last.fm/music/{encode_artist_url}/+images"
    ...
    download_folder = os.path.join(os.getcwd(), artist, "_img")
